...
/*
Exercise 2: Without worrying about deleted user or merged users, 
...
Is this the right way to count merged or deleted users? 
...
/*
Exercise 5: Use the pieces you’ve built as subtables and 
...
/*
Exercise 7:
What if there were days where no users were created, 
but some users were deleted or merged.
